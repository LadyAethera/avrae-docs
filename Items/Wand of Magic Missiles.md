...
Usage: `!wandmm` `!wandmm [cast-at level]` `!wandmm recharge`<br />
*Currently limited to casting at level 6 due to Avrae character limit.*
...
```GN
!alias wandmm embed
{{set("counter", "Wand of Magic Missiles")}}
{{breaks = 1 if get_cc(counter)==1 and roll("1d20")==1 else 0}}
{{d1 = roll("1d4")}}{{d2 = roll("1d4")}}{{d3 = roll("1d4")}}{{d4 = roll("1d4")}}{{d5 = roll("1d4")}}{{d6 = roll("1d4")}}{{d7 = roll("1d4")}}{{d8 = roll("1d4")}}
{{regain = roll("1d6+1")}}
